...
2. **<span class="text-span">OctoFi Token:</span>** an ERC-20 on the Etherum network, OCTO is used to govern the project, unlock exclusive features, and earn your share of revenue.

## 🤔 How does it work?

When you transact with any of our [referral partners](/partners) using our dapp. 100% of any commissions generated by your transactions will be directed to our token holders.
...
**Several members of the Octagon left or were removed and their positions need to be filled.*
...
### 2. <span class="text-span">Token</span> ([OCTO](https://etherscan.io/token/0x7240ac91f01233baaf8b064248e80feaa5912ba3))
