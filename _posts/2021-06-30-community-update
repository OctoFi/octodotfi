...
In May we published our [Development and Marketing Priorities Q2/Q3](https://octo.fi/blog/development-and-marketing-priorities) blog post. In the update we identified all the UI/UX and product improvements that need to be addressed to make OctoFi a platform with a clear purpose and path toward user adoption. If you want to take a closer look at the development side of things, you can view [todo.octo.fi](http://todo.octo.fi), [milestones.octo.fi](http://milestones.octo.fi), or [priority.octo.fi](http://priority.octo.fi).
